...
final class C1406am extends Lambda implements Function1<EmMoc3Source, List<Integer>> {

    /* renamed from: a */
    public static final C1406am INSTANCE = new C1406am();
    ...
    public List<Integer> invoke(EmMoc3Source receiver) {
        ...
        return receiver.getEmModelSource().getEmPartSources().getKeyformSourcesBeginIndex();
    }
}
